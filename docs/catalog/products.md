---
title: Products
description: Add, edit, price, stock, and publish products with optional variants.
---

# Products

**Where:** **Products** in the bottom navigation

![Products list on mobile](/img/screenshots/products-list.png)

Your product list is the catalogue customers shop from.
...
| Field | Notes |
|-------|--------|
| **Name** | Required. Clear and searchable. |
| **Description** | Optional. Benefits, fabric, care, size notes. |
| **Images** | Multiple photos supported. First image is usually the main thumbnail. |
...
## Variants (size, colour, and similar)
...
Home can show how many active products are fully out of stock. Restock variants or the simple product stock so customers can buy again.
